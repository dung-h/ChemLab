...
\clearpage
\section*{\centering BÁO CÁO SỐ LIỆU THÍ NGHIỆM}
\addcontentsline{toc}{section}{BÁO CÁO SỐ LIỆU THÍ NGHIỆM}
\begin{figure}[H]
    \centering
    \includegraphics[max width=\linewidth, height=0.85\textheight, keepaspectratio]{baocaosolieuthinghiem.jpg}
    \caption{Bản báo cáo số liệu thực nghiệm gốc}
\end{figure}

\clearpage

\input{chapters/baocao/bai2.tex}
\input{chapters/baocao/bai4.tex}
\input{chapters/baocao/bai8.tex}
