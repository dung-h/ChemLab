...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            $t_2$ ($^\circ$C) & 52 & 66 & 64 \\
            \hline
            $t_3$ ($^\circ$C) & 42.4 & 50 & 48 \\
            \hline
            $m_0c_0$ (cal/độ) & 9.38 & 9.38 & 3.13 \\
            \hline
        \end{tabular}
    \end{table}
    \item Tính giá trị $m_0c_0$ (lấy kết quả lần 1 làm đại diện, do lần 3 có sai số lớn):
    $$m_0c_0 = \frac{mc(t_3 - t_1)}{t_2 - t_3} - mc = \frac{50 \times (42.4 - 31)}{52 - 42.4} - 50 = \frac{50 \times 11.4}{9.6} - 50 = 59.38 - 50 = 9.38 \text{ (cal/độ)}$$
\end{itemize}
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            $t_3$ ($^\circ$C) & 32 & 34 & 34 \\
            \hline
            $Q$ (cal) & 166.045 & 241.52 & 286.805 \\
            \hline
            $Q$ trung bình (cal) & \multicolumn{3}{c|}{231.46} \\
            \hline
            $\Delta H$ (cal/mol) & $-6641.8$ & $-9660.8$ & $-11472.2$ \\
            \hline
            $\Delta H$ trung bình (cal/mol) & \multicolumn{3}{c|}{$-9258.3$} \\
            \hline
        \end{tabular}
    \end{table}
    ...
    \begin{align*}
        ...
        Q &= (m_0c_0 + mc)\left(t_3 - \frac{t_1 + t_2}{2}\right) \\
          &= (9.38 + 51 \times 1)\left(32 - \frac{29.5 + 29}{2}\right) = 60.38 \times 2.75 = 166.045 \text{ (cal)}
    \end{align*}
    Phương trình hóa học:
    \begin{align*}
        &\text{NaOH} + \text{HCl} \rightarrow \text{NaCl} + \text{H}_2\text{O} \\
        &0.025 \quad 0.025 \quad 0.025 \\
        \Delta H &= -\frac{Q}{n} = -\frac{166.045}{0.025} = -6641.8 \text{ (cal/mol)}
    \end{align*}
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            \hline
            $Q$ (cal) & 380.28 & 380.28 & 443.66 \\
            \hline
            $\Delta H$ (cal/mol) & $-15211.2$ & $-15211.2$ & $-17746.4$ \\
            \hline
            $\Delta H$ trung bình (cal/mol) & \multicolumn{3}{c|}{$-16056.3$} \\
            \hline
        \end{tabular}
    \end{table}
    \item Tính giá trị Q và $\Delta H$ (lấy lần 1 làm đại diện):
    \begin{align*}
        ...
        Q &= (m_0c_0 + mc)\Delta t \\
          &= (9.38 + 54 \times 1) \times 6 = 63.38 \times 6 = 380.28 \text{ (cal)} \\
        \Delta H &= -\frac{Q}{n} = -\frac{380.28}{0.025} = -15211.2 \text{ (cal/mol)}
    \end{align*}
    \item Kết luận: Vì $\Delta H < 0$ nên đây là phản ứng tỏa nhiệt.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            \hline
            $Q$ (cal) & $-316.9$ & $-253.52$ & $-316.9$ \\
            \hline
            $\Delta H$ (cal/mol) & $+4238.3$ & $+3390.7$ & $+4238.3$ \\
            \hline
            $\Delta H$ trung bình (cal/mol) & \multicolumn{3}{c|}{$+3955.8$} \\
            \hline
        \end{tabular}
    \end{table}
    \item Tính giá trị Q và $\Delta H$ (lấy lần 1 làm đại diện):
    \begin{align*}
        ...
        Q &= (m_0c_0 + mc)\Delta t \\
          &= (9.38 + 54 \times 1) \times (-5) = 63.38 \times (-5) = -316.9 \text{ (cal)} \\
        \Delta H &= -\frac{Q}{n} = -\frac{-316.9}{0.07477} = +4238.3 \text{ (cal/mol)}
    \end{align*}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Theo thực nghiệm: $\Delta H_3 = -16.056 \text{ (kcal/mol)}$
