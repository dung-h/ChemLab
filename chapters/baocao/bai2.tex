...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \end{tabular}
    \end{table}
    \item Giá trị $m_0c_0$ trung bình:
    $$m_0c_0 = \frac{9.38 + 9.38 + 3.13}{3} \approx 7.30 \text{ (cal/độ)}$$
\end{itemize}
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            $t_3$ ($^\circ$C) & 32 & 34 & 34 \\
            \hline
            $Q$ (cal) & 160.33 & 233.20 & 276.93 \\
            \hline
            $Q$ trung bình (cal) & \multicolumn{3}{c|}{223.48} \\
            \hline
            $\Delta H$ (cal/mol) & $-6413.2$ & $-9328.0$ & $-11077.2$ \\
            \hline
            $\Delta H$ trung bình (cal/mol) & \multicolumn{3}{c|}{$-8939.5$} \\
            \hline
        \end{tabular}
    \end{table}
    ...
    \begin{align*}
        ...
        Q &= (m_0c_0 + mc)\left(t_3 - \frac{t_1 + t_2}{2}\right) \\
          &= (7.30 + 51 \times 1)\left(32 - \frac{29.5 + 29}{2}\right) = 58.30 \times 2.75 \approx 160.33 \text{ (cal)}
    \end{align*}
    Phương trình hóa học:
    \begin{align*}
        &\text{NaOH} + \text{HCl} \rightarrow \text{NaCl} + \text{H}_2\text{O} \\
        &0.025 \quad 0.025 \quad 0.025 \\
        \Delta H &= -\frac{Q}{n} = -\frac{160.33}{0.025} \approx -6413.2 \text{ (cal/mol)}
    \end{align*}
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            \hline
            $Q$ (cal) & 367.80 & 367.80 & 429.10 \\
            \hline
            $\Delta H$ (cal/mol) & $-14712.0$ & $-14712.0$ & $-17164.0$ \\
            \hline
            $\Delta H$ trung bình (cal/mol) & \multicolumn{3}{c|}{$-15529.3$} \\
            \hline
        \end{tabular}
    \end{table}
    \item Tính giá trị Q và $\Delta H$ (lấy lần 1 làm đại diện):
    \begin{align*}
        ...
        Q &= (m_0c_0 + mc)\Delta t \\
          &= (7.30 + 54 \times 1) \times 6 = 61.30 \times 6 = 367.80 \text{ (cal)} \\
        \Delta H &= -\frac{Q}{n} = -\frac{367.80}{0.025} \approx -14712.0 \text{ (cal/mol)}
    \end{align*}
    \item Kết luận: Vì $\Delta H < 0$ nên đây là phản ứng tỏa nhiệt.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            \hline
            $Q$ (cal) & $-306.50$ & $-245.20$ & $-306.50$ \\
            \hline
            $\Delta H$ (cal/mol) & $+4099.2$ & $+3279.4$ & $+4099.2$ \\
            \hline
            $\Delta H$ trung bình (cal/mol) & \multicolumn{3}{c|}{$+3825.9$} \\
            \hline
        \end{tabular}
    \end{table}
    \item Tính giá trị Q và $\Delta H$ (lấy lần 1 làm đại diện):
    \begin{align*}
        ...
        Q &= (m_0c_0 + mc)\Delta t \\
          &= (7.30 + 54 \times 1) \times (-5) = 61.30 \times (-5) = -306.50 \text{ (cal)} \\
        \Delta H &= -\frac{Q}{n} = -\frac{-306.50}{0.07477} \approx +4099.2 \text{ (cal/mol)}
    \end{align*}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Theo thực nghiệm: $\Delta H_3 = -15.529 \text{ (kcal/mol)}$
