...
\begin{itemize}
    ...
    \begin{align*}
        ...
        Q &= (m_0c_0 + mc)\left(t_3 - \frac{t_1 + t_2}{2}\right) \\
          &= (7.30 + 51 \times 1)\left(32 - \frac{29.5 + 29}{2}\right) = 58.30 \times 2.75 = 160.33 \text{ (cal)}
    \end{align*}
    Phương trình hóa học:
    \begin{align*}
        &\text{NaOH} + \text{HCl} \rightarrow \text{NaCl} + \text{H}_2\text{O} \\
        &0.025 \quad 0.025 \quad 0.025 \\
        \Delta H &= -\frac{Q}{n} = -\frac{160.33}{0.025} = -6413.2 \text{ (cal/mol)}
    \end{align*}
...
\begin{itemize}
    ...
    \begin{align*}
        ...
        \Delta H &= -\frac{Q}{n} = -\frac{367.80}{0.025} = -14712.0 \text{ (cal/mol)}
    \end{align*}
    \item Kết luận: Vì $\Delta H < 0$ nên đây là phản ứng tỏa nhiệt.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{align*}
        ...
        \Delta H &= -\frac{Q}{n} = -\frac{-306.50}{0.07477} = +4099.2 \text{ (cal/mol)}
    \end{align*}
