...
\begin{itemize}
    ...
    \item Tuy nhiên, để chính xác hơn cho các thí nghiệm sau, ta sử dụng giá trị trung bình chính xác là $7.29$ cal/độ.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            \hline
            $Q$ trung bình (cal) & \multicolumn{3}{c|}{223.45} \\
            \hline
            $\Delta H$ (cal/mol) & $-6412.0$ & $-9326.4$ & $-11075.2$ \\
            \hline
            $\Delta H$ trung bình (cal/mol) & \multicolumn{3}{c|}{$-8937.8$} \\
            \hline
        \end{tabular}
    \end{table}
    ...
    \begin{align*}
        ...
        Q &= (m_0c_0 + mc)\left(t_3 - \frac{t_1 + t_2}{2}\right) \\
          &= (7.29 + 51 \times 1)\left(32 - \frac{29.5 + 29}{2}\right) = 58.29 \times 2.75 = 160.30 \text{ (cal)}
    \end{align*}
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            \hline
            $\Delta H$ (cal/mol) & $-14709.6$ & $-14709.6$ & $-17161.2$ \\
            \hline
            $\Delta H$ trung bình (cal/mol) & \multicolumn{3}{c|}{$-15526.8$} \\
            \hline
        \end{tabular}
    \end{table}
    \item Tính giá trị Q và $\Delta H$ (lấy lần 1 làm đại diện):
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
            ...
            \hline
            $\Delta H$ (cal/mol) & $+4098.6$ & $+3278.9$ & $+4098.6$ \\
            \hline
            $\Delta H$ trung bình (cal/mol) & \multicolumn{3}{c|}{$+3825.4$} \\
            \hline
        \end{tabular}
    \end{table}
    \item Tính giá trị Q và $\Delta H$ (lấy lần 1 làm đại diện):
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Theo thực nghiệm: $\Delta H_3 = -15.527 \text{ (kcal/mol)}$
