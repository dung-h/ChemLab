...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \end{tabular}
    \end{table}
    \item $\overline{C_{HCl}} = \frac{1}{3} \sum_{i=1}^{3} C_{HCl\_i} = \frac{1}{3}(0.100 + 0.103 + 0.101) \approx 0.1013 \text{ (N)}$
    ...
    \item Sai số trung bình: $\overline{\Delta C_{HCl}} = \frac{1}{3} \sum_{i=1}^{3} \Delta C_{HCl\_i} = \frac{1}{3}(0.0013 + 0.0017 + 0.0003) \approx 0.0011 \text{ (N)}$
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \end{tabular}
    \end{table}
    \item $\overline{C_{HCl}} = \frac{1}{3} \sum_{i=1}^{3} C_{HCl\_i} = \frac{1}{3}(0.105 + 0.101 + 0.103) \approx 0.103 \text{ (N)}$
    \item Ta tính được sai số tuyệt đối của mỗi lần đo theo công thức: $\Delta C_{HCl} = |C_{HCl\_i} - \overline{C_{HCl}}|$
    \item $\Rightarrow$ Các giá trị sai số được thể hiện ở bảng trên.
    \item Sai số trung bình: $\overline{\Delta C_{HCl}} = \frac{1}{3} \sum_{i=1}^{3} \Delta C_{HCl\_i} = \frac{1}{3}(0.002 + 0.002 + 0.000) \approx 0.0013 \text{ (N)}$
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \end{tabular}
    \end{table}
    \item $\overline{C_{CH_3COOH}} = \frac{1}{3}\sum_{i=1}^{3} C_{CH_3COOH\_i} = \frac{1}{3}(0.089 + 0.090 + 0.089) \approx 0.0893 \text{ (N)}$
    \item Ta tính được sai số tuyệt đối của mỗi lần đo theo công thức: $\Delta C_{CH_3COOH} = |C_{CH_3COOH\_i} - \overline{C_{CH_3COOH}}|$
    \item $\Rightarrow$ Các giá trị sai số được thể hiện ở bảng trên.
    \item Sai số trung bình: $\overline{\Delta C_{CH_3COOH}} = \frac{1}{3} \sum_{i=1}^{3} \Delta C_{CH_3COOH\_i} = \frac{1}{3}(0.0003 + 0.0007 + 0.0003) \approx 0.0004 \text{ (N)}$
